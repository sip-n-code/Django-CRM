...
# Create a form for adding records
class AddRecordForm(forms.ModelForm):
    ...
    address = forms.CharField(required=True, label='', max_length=255, widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Address'}))
